...
- The canonical token contract documents machine-consumed token names and values.
- Client DESIGN.md, when used, is a Designer-verified explanation derived from Figma and the token contract. It does not replace either source.
