# Figma Component and Naming Standard

AI Web Design System v0.1 (Pilot). The naming conventions and structure every project must follow. This keeps Figma files machine-readable for the AI workflow and consistent across designers.

## Variable Naming

Use forward-slash grouping and semantic names. Lower case, hyphen for multi-word.
...
- Absolute positioning, except deliberate z-index overlaps that are documented.
...
- **Standard applied and checked**: [Name], [YYYY-MM-DD]
