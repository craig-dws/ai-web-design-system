...
- **Use Code Connect.** It is the single biggest accuracy lever for Figma-to-code on both targets, because it makes the agent reuse real components instead of inventing new ones each time.
